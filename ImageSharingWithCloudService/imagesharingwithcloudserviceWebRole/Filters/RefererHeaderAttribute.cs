...
namespace imagesharingwithcloudserviceWebRole.Filters
{
    ...
    public class RefererHeaderAttribute : AuthorizeAttribute
    {
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            if (filterContext.HttpContext != null)
            {
                ...
                if (filterContext.HttpContext.Request.UrlReferrer.Host != ConfigurationManager.AppSettings["WebSiteURL"])
